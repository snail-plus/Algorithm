...
//miniui
document.write('<script src="' + bootPATH + 'miniui/jquery-1.6.2.min.js" type="text/javascript"></sc' + 'ript>');
document.write('<script src="' + bootPATH + 'miniui/miniui_crack_3.2.js" type="text/javascript" ></sc' + 'ript>');
